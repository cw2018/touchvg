...
public:
    ...
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback20_t)(int, float, float, float, float);
    typedef void (SWIGSTDCALL* SWIG_Callback21_t)(int, float, float);
...
public:
    ...
    typedef void * (SWIGSTDCALL* SWIG_Callback15_t)(int);
    typedef void (SWIGSTDCALL* SWIG_Callback16_t)(int, void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback17_t)();
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback18_t)();
    typedef float (SWIGSTDCALL* SWIG_Callback19_t)(void *, float, void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback20_t)(void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback21_t)(int, void *, void *, int);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback22_t)(void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback23_t)(void *, void *);
    typedef int (SWIGSTDCALL* SWIG_Callback24_t)();
    typedef void * (SWIGSTDCALL* SWIG_Callback25_t)(int);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback26_t)(int, void *, float);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback27_t)(int);
    typedef int (SWIGSTDCALL* SWIG_Callback28_t)(int);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback29_t)(void *, int);
    typedef void (SWIGSTDCALL* SWIG_Callback30_t)(int, unsigned int);
...
private:
    ...
    SWIG_Callback9_t swig_callbackafterChanged;
    SWIG_Callback10_t swig_callbackupdate;
    SWIG_Callback11_t swig_callbacktransform;
    SWIG_Callback12_t swig_callbackclear;
    SWIG_Callback13_t swig_callbackclearCachedData;
    SWIG_Callback14_t swig_callbackgetPointCount;
    SWIG_Callback15_t swig_callbackgetPoint;
    SWIG_Callback16_t swig_callbacksetPoint;
    SWIG_Callback17_t swig_callbackisClosed;
    SWIG_Callback18_t swig_callbackisCurve;
    SWIG_Callback19_t swig_callbackhitTest;
    SWIG_Callback20_t swig_callbackhitTestBox;
    SWIG_Callback21_t swig_callbackdraw;
    SWIG_Callback22_t swig_callbacksave;
    SWIG_Callback23_t swig_callbackload;
    SWIG_Callback24_t swig_callbackgetHandleCount;
    SWIG_Callback25_t swig_callbackgetHandlePoint;
    SWIG_Callback26_t swig_callbacksetHandlePoint;
    SWIG_Callback27_t swig_callbackisHandleFixed;
    SWIG_Callback28_t swig_callbackgetHandleType;
    SWIG_Callback29_t swig_callbackoffset;
    SWIG_Callback30_t swig_callbacksetFlag;
    void swig_init_callbacks();
};
...
public:
    ...
    virtual MgShape *getShape(MgMotion const *sender);
...
private:
    ...
    SWIG_Callback17_t swig_callbackgetShape;
    void swig_init_callbacks();
};
...
public:
    ...
    virtual bool isFloatingCommand();
    virtual bool doContextAction(MgMotion const *sender, int action);
    virtual MgShape *getShape(MgMotion const *arg0);
...
private:
    ...
    SWIG_Callback16_t swig_callbackdoContextAction;
    SWIG_Callback17_t swig_callbackgetShape;
    SWIG_Callback18_t swig_callbackgetShapeType;
